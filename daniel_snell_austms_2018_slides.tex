...
\begin{frame}{A conformal example}
  ...
  \begin{proof}[Proof (sketch)]
    ...
    \begin{itemize}
      ...
      \item use techniques from BGG theory, work of \v{C}ap, Sou\v{c}ek, Somberg, \v{S}ilhan...
    \end{itemize}
  \end{proof}
\end{frame}
...
\begin{frame}{Thank you}
  ...
  \hspace{1em}\\
  Contact: \href{mailto:daniel.snell@auckland.ac.nz}{daniel.snell@auckland.ac.nz}
  \end{block}
\end{frame}
